      ...
      <div class="flex h-16 items-center justify-between">
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <!-- Profile dropdown -->
            <div class="relative ml-3" x-data="{ profileOpen: false }" @click.away="profileOpen = false">
              <div>
        ...
        <div class="-mr-2 flex md:hidden">
         <!-- Mobile menu button -->
          <button type="button" 
            ...
            <svg x-show="!isOpen" class="block size-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
    ...
    <div x-show="isOpen" 
      ...
      <div class="border-t border-gray-700 pt-4 pb-3">
        <div class="flex items-center px-5">
          <div class="shrink-0">
            <img class="size-10 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad" alt="" />
          </div>
          <div class="ml-3">
